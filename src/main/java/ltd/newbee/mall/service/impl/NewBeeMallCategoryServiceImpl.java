...
//		SearchPageCategoryVO searchPageCategoryVO = new SearchPageCategoryVO();
//
//		GoodsCategory LevelGoodsCategory = goodsCategoryMapper.selectByPrimaryKey(categoryId);
//
//		GoodsCategory secondLevelGoodsCategory = null;
//		GoodsCategory thirdLevelGoodsCategory = null;
//
//		if (LevelGoodsCategory.categoryLevel == 2) {
//			secondLevelGoodsCategory = LevelGoodsCategory;
//		} else {
//			thirdLevelGoodsCategory = LevelGoodsCategory;
//		}
//
//		if (secondLevelGoodsCategory.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_TWO.getLevel()) {
//			// 获取当前二级分类下的三级分类List
//			List<GoodsCategory> thirdLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(
//					Collections.singletonList(secondLevelGoodsCategory.getCategoryId()),
//					NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel(), Constants.SEARCH_CATEGORY_NUMBER);
...
//				&& thirdLevelGoodsCategory.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel()) {
//			// 获取当前三级分类的二级分类
//			GoodsCategory secondLevelGoodsCategory2 = goodsCategoryMapper
//					.selectByPrimaryKey(thirdLevelGoodsCategory.getParentId());
//			if (secondLevelGoodsCategory2 != null && secondLevelGoodsCategory2
//					.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_TWO.getLevel()) {
//				// 获取当前二级分类下的三级分类List
//				List<GoodsCategory> thirdLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(
//						Collections.singletonList(secondLevelGoodsCategory.getCategoryId()),
//						NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel(), Constants.SEARCH_CATEGORY_NUMBER);
//				searchPageCategoryVO.setCurrentCategoryName(thirdLevelGoodsCategory.getCategoryName());
//				searchPageCategoryVO.setSecondLevelCategoryName(secondLevelGoodsCategory2.getCategoryName());
//				searchPageCategoryVO.setThirdLevelCategoryList(thirdLevelCategories);
//				return searchPageCategoryVO;
//			}
//		}
...
//          //获取当前三级分类的二级分类
//          GoodsCategory secondLevelGoodsCategory2 = goodsCategoryMapper.selectByPrimaryKey(thirdLevelGoodsCategory.getParentId());
//          if (secondLevelGoodsCategory2 != null && secondLevelGoodsCategory2.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_TWO.getLevel()) {
//              //获取当前二级分类下的三级分类List
//              List<GoodsCategory> thirdLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(Collections.singletonList(secondLevelGoodsCategory.getCategoryId()), NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel(), Constants.SEARCH_CATEGORY_NUMBER);
//              searchPageCategoryVO.setCurrentCategoryName(thirdLevelGoodsCategory.getCategoryName());
//              searchPageCategoryVO.setSecondLevelCategoryName(secondLevelGoodsCategory2.getCategoryName());
